...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Picks_table_widget = QTableWidget(self.PIcks_box)
        ...
        self.Save_Picks_buttom = QPushButton(self.PIcks_box)
        self.Save_Picks_buttom.setObjectName(u"Save_Picks_buttom")

        self.Picks_layout.addWidget(self.Save_Picks_buttom)


        self.verticalLayout_3.addLayout(self.Picks_layout)


        self.Layout_with_Picks_box.addWidget(self.PIcks_box)


        self.formLayout.setLayout(4, QFormLayout.ItemRole.LabelRole, self.Layout_with_Picks_box)
